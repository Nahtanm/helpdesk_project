...
public class ResourceExceptionHandler {
 ...
 public ResponseEntity<StandardError> existingObject(DataIntegrityViolationException exception, HttpServletRequest httpServletRequest){
	 StandardError err = new StandardError(Instant.now(), 
				HttpStatus.BAD_REQUEST.value(),
				"Data violation", exception.getMessage(), 
				httpServletRequest.getRequestURI());
